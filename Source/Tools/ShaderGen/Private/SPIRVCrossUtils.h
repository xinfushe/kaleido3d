...
void ExtractAttributeData(spirv_cross::CompilerGLSL const& backCompiler, k3d::NGFXShaderAttributes & outShaderAttributes);
void ExtractUniformData(NGFXShaderType shaderStage, spirv_cross::CompilerGLSL const& backCompiler, k3d::NGFXShaderBindingTable& outUniformLayout);
