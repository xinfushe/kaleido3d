...
public:
  ...
  inline const VkAttachmentDescription* GetAttachmentDescriptions() const
  {
    return m_Desc;
  }
  ...
  inline bool GetHasResolveAttachments() const
  {
  ...
  {
    return m_NumColorAttachments > 0 ? m_ColorReferences : nullptr;
  }
  inline const VkAttachmentReference* GetResolveAttachmentReferences() const
  {
    return m_HasResolveAttachments ? m_ResolveReferences : nullptr;
  }
  inline const VkAttachmentReference* GetDepthStencilAttachmentReference() const
  {
    return m_HasDepthStencil ? &m_DepthStencilReference : nullptr;
  }
...
public:
  struct Description : public VkAttachmentDescription
  {
    ...
    Description() { flags = 0; }
    Description& Format(VkFormat const& fmt)
    {
      this->format = fmt;
      return *this;
    }
    Description& Samples(VkSampleCountFlagBits const& sample)
    {
      this->samples = sample;
      return *this;
    }
    Description& LoadOp(VkAttachmentLoadOp const& op)
    {
      this->loadOp = op;
      return *this;
    }
    Description& StoreOp(VkAttachmentStoreOp const& op)
    {
      this->storeOp = op;
      return *this;
    }
    Description& StencilLoadOp(VkAttachmentLoadOp const& op)
    {
      this->stencilLoadOp = op;
      return *this;
    }
    Description& StencilStoreOp(VkAttachmentStoreOp const& op)
    {
      this->stencilStoreOp = op;
      return *this;
    }
    Description& InitialLayout(VkImageLayout const& layout)
    {
      this->initialLayout = layout;
      return *this;
    }
    Description& FinalLayout(VkImageLayout const& layout)
    {
  ...
  RenderpassAttachment(VkFormat fmt = VK_FORMAT_UNDEFINED,
                       VkSampleCountFlagBits samples = VK_SAMPLE_COUNT_1_BIT);
  virtual ~RenderpassAttachment() {}

  RenderpassAttachment& SetClearValue(const VkClearValue& value)
  {
    m_ClearValue = value;
    return *this;
  }
  ...
  static RenderpassAttachment CreateColor(
    VkFormat format,
    VkSampleCountFlagBits samples = VK_SAMPLE_COUNT_1_BIT);
  static RenderpassAttachment CreateDepthStencil(
    VkFormat format,
    VkSampleCountFlagBits samples = VK_SAMPLE_COUNT_1_BIT);
...
struct K3D_API Subpass
{
  ...
  const std::vector<uint32>& GetColorAttachments() const
  {
    return m_ColorAttachments;
  }
  const std::vector<uint32>& GetDepthStencilAttachment() const
  {
  ...
  Subpass& AddColorAttachment(
    ...
    uint32 resolveAttachmentIndex = VK_ATTACHMENT_UNUSED);
...
public:
  ...
  SubpassDependency& SrcSubpass(uint32 subpass)
  {
    m_Dependency.srcSubpass = subpass;
    return *this;
  }
  SubpassDependency& DstSubpass(uint32 subpass)
  {
    m_Dependency.dstSubpass = subpass;
    return *this;
  }
  SubpassDependency& SrcStageMask(VkPipelineStageFlags mask,
                                  bool exclusive = false);
  SubpassDependency& DstStageMask(VkPipelineStageFlags mask,
                                  bool exclusive = false);
  SubpassDependency& StageMasks(VkPipelineStageFlags srcStageMask,
  ...
  SubpassDependency& AccessMasks(VkAccessFlags srcAccessMask,
...
public:
  ...
  RenderpassOptions() {}
  RenderpassOptions(VkFormat colorFormat,
                    VkSampleCountFlagBits samples = VK_SAMPLE_COUNT_1_BIT);
  RenderpassOptions(VkFormat colorFormat,
  ...
  RenderpassOptions& AddAttachment(const RenderpassAttachment& value)
  {
    m_Attachments.push_back(value);
    return *this;
  }
  RenderpassOptions& AddSubPass(const Subpass& value)
  {
    m_Subpasses.push_back(value);
    return *this;
  }
  RenderpassOptions& AddSubpassDependency(const SubpassDependency& value)
  {
    m_SubpassDependencies.push_back(value);
    return *this;
  }
...
{
public:
  BufferMemoryBarrierParams(VkBuffer buffer,
                            VkAccessFlags srcAccessMask,
                            VkAccessFlags dstAccessMask,
                            VkPipelineStageFlags srcStageMask = 0,
                            VkPipelineStageFlags dstStageMask = 0);
  virtual ~BufferMemoryBarrierParams() {}
  BufferMemoryBarrierParams& SrcAccessMask(VkAccessFlags value,
                                           bool exclusive = false)
  {
    if (exclusive) {
      m_Barrier.srcAccessMask = value;
    } else {
      m_Barrier.srcAccessMask |= value;
    }
    return *this;
  }
  BufferMemoryBarrierParams& DstAccessMask(VkAccessFlags value,
                                           bool exclusive = false)
  {
    if (exclusive) {
      m_Barrier.dstAccessMask = value;
    } else {
      m_Barrier.dstAccessMask |= value;
    }
    return *this;
  }
  BufferMemoryBarrierParams& SrcQueueFamilyIndex(VkAccessFlags value)
  {
    m_Barrier.srcQueueFamilyIndex = value;
    return *this;
  }
  BufferMemoryBarrierParams& DstQueueFamilyIndex(VkAccessFlags value)
  {
    m_Barrier.dstQueueFamilyIndex = value;
    return *this;
  }
  BufferMemoryBarrierParams& Offset(VkDeviceSize value)
  {
    m_Barrier.offset = value;
    return *this;
  }
  BufferMemoryBarrierParams& Size(VkDeviceSize value)
  {
    m_Barrier.size = value;
    return *this;
  }
  BufferMemoryBarrierParams& SrcStageMask(VkPipelineStageFlags value,
                                          bool exclusive = false)
  {
    if (exclusive) {
      m_SrcStageMask = value;
    } else {
      m_SrcStageMask |= value;
    }
    return *this;
  }
  BufferMemoryBarrierParams& DstStageMask(VkPipelineStageFlags value,
                                          bool exclusive = false)
  {
    if (exclusive) {
      m_DstStageMask = value;
    } else {
      m_DstStageMask |= value;
    }
    return *this;
...
{
public:
  ImageMemoryBarrierParams(VkImage image,
  ...
  ImageMemoryBarrierParams& SrcAccessMask(VkAccessFlags value,
                                          bool exclusive = false)
  {
    if (exclusive) {
      m_Barrier.srcAccessMask = value;
  ...
  ImageMemoryBarrierParams& DstAccessMask(VkAccessFlags value,
                                          bool exclusive = false)
  {
    if (exclusive) {
      m_Barrier.dstAccessMask = value;
  ...
  ImageMemoryBarrierParams& OldLayout(VkImageLayout value)
  {
    m_Barrier.oldLayout = value;
    return *this;
  }
  ImageMemoryBarrierParams& NewLayout(VkImageLayout value)
  {
    m_Barrier.newLayout = value;
    return *this;
  }
  ImageMemoryBarrierParams& SrcQueueFamilyIndex(VkAccessFlags value)
  {
    m_Barrier.srcQueueFamilyIndex = value;
    return *this;
  }
  ImageMemoryBarrierParams& DstQueueFamilyIndex(VkAccessFlags value)
  {
    m_Barrier.dstQueueFamilyIndex = value;
    return *this;
  }
  ImageMemoryBarrierParams& AspectMask(VkImageAspectFlags value,
                                       bool exclusive = false)
  {
    if (exclusive) {
      m_Barrier.subresourceRange.aspectMask = value;
    } else {
      m_Barrier.subresourceRange.aspectMask |= value;
    }
    return *this;
  }
  ImageMemoryBarrierParams& BaseMipLevel(uint32 value)
  {
    m_Barrier.subresourceRange.baseMipLevel = value;
    return *this;
  }
  ImageMemoryBarrierParams& MipLevelCount(uint32 value)
  {
    m_Barrier.subresourceRange.levelCount = value;
    return *this;
  }
  ImageMemoryBarrierParams& BaseArrayLayer(uint32 value)
  {
    m_Barrier.subresourceRange.baseArrayLayer = value;
    return *this;
  }
  ImageMemoryBarrierParams& LayerCount(uint32 value)
  {
    m_Barrier.subresourceRange.layerCount = value;
    return *this;
  }
  ImageMemoryBarrierParams& SubResourceRange(VkImageSubresourceRange range)
  {
    m_Barrier.subresourceRange = range;
    return *this;
  }
  ImageMemoryBarrierParams& SrcStageMask(VkPipelineStageFlags value,
                                         bool exclusive = false)
  {
    if (exclusive) {
      m_SrcStageMask = value;
  ...
  ImageMemoryBarrierParams& DstStageMask(VkPipelineStageFlags value,
                                         bool exclusive = false)
  {
    if (exclusive) {
      m_DstStageMask = value;
...
{
  CmdBufAllocInfo()
    : CmdBufAllocInfo(VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO,
                      nullptr,
                      VK_NULL_HANDLE,
  ...
  CmdBufAllocInfo(VkStructureType type,
                  const void* next,
                  VkCommandPool pool,
   ...
   * @param buffCount
   */
  static VkCommandBufferAllocateInfo Create(
    VkCommandPool pool,
    VkCommandBufferLevel lev = VK_COMMAND_BUFFER_LEVEL_PRIMARY,
    uint32 bufCnt = 1)
  {
    CmdBufAllocInfo info(VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO,
                         nullptr,
                         pool,
                         lev,
                         bufCnt);
...
public:
  ...
  ImageViewInfo(VkFormat format_,
                VkImage image_,
  ...
  static std::pair<VkImageView, VkImageViewCreateInfo>
