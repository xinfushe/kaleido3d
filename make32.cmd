...
cmake -G"Visual Studio 15 2017" -HSource -BBuild\Win32\Debug -DCMAKE_BUILD_TYPE=Debug -DBUILD_WITH_EDITOR=%BUILD_EDITOR% -DBUILD_WITH_CPP_REFLECTOR=%BUILD_WITH_CPP_REFLECTOR%
if "%ERRORLEVEL%"=="0" (goto BUILD_CMAKE)
RD /S /Q Build

echo Now Generate Project by CMake (VS 2015)
cmake -G"Visual Studio 14 2015" -HSource -BBuild\Win32\Debug -DCMAKE_BUILD_TYPE=Debug -DBUILD_WITH_EDITOR=%BUILD_EDITOR% -DBUILD_WITH_CPP_REFLECTOR=%BUILD_WITH_CPP_REFLECTOR%
