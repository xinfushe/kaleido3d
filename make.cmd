...
cmake -G"Visual Studio 15 2017 Win64" -HSource -BBuild\Win64\Debug -DCMAKE_BUILD_TYPE=Debug -DBUILD_WITH_EDITOR=%BUILD_EDITOR% -DBUILD_WITH_CPP_REFLECTOR=%BUILD_WITH_CPP_REFLECTOR%
if "%ERRORLEVEL%"=="0" (goto BUILD_CMAKE)
RD /S /Q Build

echo Now Generate Project by CMake (VS 2015)
cmake -G"Visual Studio 14 2015 Win64" -HSource -BBuild\Win64\Debug -DCMAKE_BUILD_TYPE=Debug -DBUILD_WITH_EDITOR=%BUILD_EDITOR% -DBUILD_WITH_CPP_REFLECTOR=%BUILD_WITH_CPP_REFLECTOR%
